...
class Product(models.Model):
	...
	def get_single_product_commission(self):
		category = self.categories.first()
		commission = 0.00
		if self.sale_price and category.care_commission:
			commission = round((category.care_commission / 100) * self.sale_price, 2)
		return commission
...
class Category(MPTTModel):
    ...
    care_commission = models.DecimalField(decimal_places=2, max_digits=20, blank=True, null=True)
